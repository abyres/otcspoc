...
import static net.abyres.tm.Mobile.MENU_LAYER;
import static net.abyres.tm.Mobile.PRIMARY_VIEW;
import static net.abyres.tm.Mobile.REQUEST_VIEW;
...
public class DrawerManager {
    ...
    public DrawerManager() {
        ...
        final Item requestItem = new ViewItem("Request", MaterialDesignIcon.DASHBOARD.graphic(), REQUEST_VIEW);
        drawer.getItems().addAll(primaryItem, requestItem);
